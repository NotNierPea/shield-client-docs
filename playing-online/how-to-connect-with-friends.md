...
There is two ways to play with friends or randoms, by using the server browser in main menu or shield friends.<br>
...
* **First way: Lobby Browser**\
  ...
  <img src="../.gitbook/assets/image (3).png" alt="" data-size="original"><br>
